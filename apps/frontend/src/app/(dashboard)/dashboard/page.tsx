...
import { Badge } from "@/components/ui/badge"; // Need to create Badge component or just use span
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-zinc-500 dark:text-zinc-400">Renews in 12 days</p>
                    </CardContent>
                </Card>
            </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            {jobs.map((job) => (
                                <div key={job.id} className="flex items-center justify-between rounded-lg border border-zinc-100 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950/50">
